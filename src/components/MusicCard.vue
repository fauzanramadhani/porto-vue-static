<template>
  <div class="music-glass-card" v-if="enabled">
    <div class="music-content">
        ...
        <div class="disc-outer">
          <div class="disc-grooves">
            <div
              ...
              v-for="n in 12"
              :key="n"
              :style="{ width: (85 - n * 4) + '%', height: (85 - n * 4) + '%' }"
            ></div>
          </div>
      ...
      <div class="play-button" @click="goToSpotify">
...
const goToSpotify = () => {
  ...
  try {
    window.open(props.spotifyUrl, '_blank', 'noopener,noreferrer')
  } catch (e) {
...
.disc-center {
  ...
  position: absolute;
  z-index: 2;
  box-shadow: 0 0 0 1px rgba(255, 255, 255, 0.1), 0 1px 3px rgba(0, 0, 0, 0.5),
